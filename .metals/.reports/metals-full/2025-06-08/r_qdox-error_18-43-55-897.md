error id: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/CancelDeliveryRequest.java
file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/CancelDeliveryRequest.java
...
```java
offset: 113
uri: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/CancelDeliveryRequest.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/CancelDeliveryRequest.java