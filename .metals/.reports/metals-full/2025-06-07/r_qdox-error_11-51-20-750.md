error id: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DeliveryStatusPercentage.java
file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DeliveryStatusPercentage.java
...
```java
offset: 124
uri: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DeliveryStatusPercentage.java
text:
```scala
...
public class DeliveryStatusPercentage {
    String getStatus();
    Long getCount
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DeliveryStatusPercentage.java