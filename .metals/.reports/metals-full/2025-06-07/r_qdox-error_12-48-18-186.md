error id: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TransporterPerformanceDTO.java
file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TransporterPerformanceDTO.java
...
```java
offset: 215
uri: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TransporterPerformanceDTO.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TransporterPerformanceDTO.java