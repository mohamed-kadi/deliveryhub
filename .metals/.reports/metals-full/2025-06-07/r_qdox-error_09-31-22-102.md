error id: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DailyDeliveryStatsDTO.java
file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DailyDeliveryStatsDTO.java
...
```java
offset: 157
uri: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DailyDeliveryStatsDTO.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/DailyDeliveryStatsDTO.java