error id: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TopTransporterDTO.java
file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TopTransporterDTO.java
...
```java
offset: 205
uri: file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TopTransporterDTO.java
text:
```scala
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/example/deliveryhub/dto/TopTransporterDTO.java